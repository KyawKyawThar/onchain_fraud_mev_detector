...
| `app-secrets` | `JWT_SECRET`, `EVENT_STORE_WRITE_TOKEN`, `SMTP_USERNAME/PASSWORD`, `ANTHROPIC_API_KEY` | api-server, event-store, notification, copilot (JWT_SECRET gates its review API) |
