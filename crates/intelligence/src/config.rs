...
/// All runtime configuration for the intelligence service's data stores (§8,
/// §14): Postgres (system of record), Redis (hot cache), ClickHouse (adjacency
/// graph). The t4 consumer will extend this with its Kafka settings.
#[derive(Debug, Clone)]
pub struct Config {
