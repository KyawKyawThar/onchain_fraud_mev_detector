...
//! p50 < 100ms SLO from noisy-neighbor traffic (§19, Sprint 14 t4), [`degrade`]
//! is that endpoint's graceful degradation — a flagged last-known-good snapshot
